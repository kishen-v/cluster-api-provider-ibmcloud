...
func TestGetDHCPServerID(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(_ *testing.T) {
			...
			g.Expect(cliUtils.DereferencePointer(dhcpServerID)).To(Equal(cliUtils.DereferencePointer(tc.expectedID)))
		})
	}
}
...
func TestGetVPCID(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(_ *testing.T) {
			...
			g.Expect(cliUtils.DereferencePointer(vpcID)).To(Equal(cliUtils.DereferencePointer(tc.expectedID)))
		})
	}
}
...
func TestGetVPCSubnetID(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(_ *testing.T) {
			...
			g.Expect(cliUtils.DereferencePointer(subnetID)).To(Equal(cliUtils.DereferencePointer(tc.expectedID)))
		})
	}
}
...
func TestVPCSecurityGroupByName(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(_ *testing.T) {
			...
			g.Expect(cliUtils.DereferencePointer(sgID)).To(Equal(cliUtils.DereferencePointer(tc.expectedID)))
		})
	}
}
...
func TestGetTransitGatewayID(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(_ *testing.T) {
			...
			g.Expect(cliUtils.DereferencePointer(tgID)).To(Equal(cliUtils.DereferencePointer(tc.expectedID)))
		})
	}
}
...
func TestGetLoadBalancerID(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(_ *testing.T) {
			...
			g.Expect(cliUtils.DereferencePointer(lbID)).To(Equal(cliUtils.DereferencePointer(tc.expectedID)))
		})
	}
}
